...
namespace Data.Migrations
{
    ...
    [Migration("20210723154632_UserFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.DataModels.FavoriteSong", b =>
                {
                    ...
                    b.HasKey("SongId", "UserId")
                        .HasName("pk_favorite_songs");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_favorite_songs_user_id");
            ...
            modelBuilder.Entity("Models.DataModels.User", b =>
                {
                    ...
                    b.Property<string>("Photo100")
                        .HasColumnType("text")
                        .HasColumnName("photo100");

                    b.Property<string>("Photo200")
                        .HasColumnType("text")
                        .HasColumnName("photo200");

                    b.Property<string>("PhotoMaxOrig")
                        .HasColumnType("text")
                        .HasColumnName("photo_max_orig");
            ...
            modelBuilder.Entity("Models.DataModels.FavoriteSong", b =>
                {
                    b.HasOne("Models.DataModels.Song", "Song")
                        .WithMany()
                        .HasForeignKey("SongId")
                        .HasConstraintName("fk_favorite_songs_songs_song_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Models.DataModels.User", "User")
                        ...
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_favorite_songs_asp_net_users_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
